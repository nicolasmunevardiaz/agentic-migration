...
from src.adapters.bluestone_health import parse_file
...
DEFAULT_EVIDENCE_PATH = "reports/qa/data_provider_2_bluestone_health_adapter_implementation.md"


def run_bluestone_adapter_for_file(
    entity: str,
    source_file: Path,
    ...
    parsed_records = parse_file(source_file, provider_spec_root / f"{entity}.yaml")
    ...
    for parsed_record in parsed_records:
        source_record = build_bluestone_source_record(
...
def build_bluestone_source_record(
