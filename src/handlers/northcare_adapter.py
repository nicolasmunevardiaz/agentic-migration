...
from src.adapters.northcare_clinics import parse_northcare_file
...
DEFAULT_EVIDENCE_PATH = "reports/qa/data_provider_3_northcare_clinics_adapter_implementation.md"


def run_northcare_adapter_for_file(
    entity: str,
    source_file: Path,
    ...
    parsed_records = parse_northcare_file(source_file, provider_spec_root / f"{entity}.yaml")
    ...
    for parsed_record in parsed_records:
        source_record = build_northcare_source_record(
...
def build_northcare_source_record(
