...
from src.adapters.pacific_shield_insurance import parse_pacific_shield_file
from src.common.adapter_runtime import (
    AdapterRunResult,
    SourceRecord,
    build_bronze_record,
    build_silver_rows,
    build_values_by_position,
...
DEFAULT_EVIDENCE_PATH = (
    "reports/qa/data_provider_5_pacific_shield_insurance_adapter_implementation.md"
)


def run_pacific_shield_adapter_for_file(
    entity: str,
    source_file: Path,
    ...
    parsed_records = parse_pacific_shield_file(
        source_file,
        provider_spec_root / f"{entity}.yaml",
    )
    ...
    for parsed_record in parsed_records:
        source_record = build_pacific_shield_source_record(
...
def build_pacific_shield_source_record(
    ...
    expected_headers = provider_spec["parser_profile"]["parser_options"]["expected_headers"]
    return SourceRecord(
        ...
        values_by_position=build_values_by_position(values_by_header, expected_headers),
    )
