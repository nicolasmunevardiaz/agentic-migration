# NorthCare Clinics Adapter Implementation Privacy Review
...
- Discovery-era NorthCare HITL items remain visible in `reports/hitl/data_provider_3_northcare_clinics.md`.
