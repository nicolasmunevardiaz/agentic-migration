...
Plan 04.5 model changes should be made through complete `model_specs/evolution/V0_N/` snapshots. Do not use ad hoc database patches as the durable model history.
